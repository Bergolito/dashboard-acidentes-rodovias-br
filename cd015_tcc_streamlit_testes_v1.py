# -*- coding: utf-8 -*-
"""CD015 - TCC - streamlit testes - v1.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1B9f8GBsYxTeyy6Uywi_cmWez6S1wxFJ_

#Universidade Federal do Rio Grande do Sul

Curso de Especialização em Ciência de Dados

CD015 - TCC - Turma 3<br>

Professor responsável: João Luiz Dihl Comba
...
"""# Baixando os arquivos de dados gerais: acidentes_por_uf, acidentes_por_tipo,  acidentes_por_br e acidentes_por_causa."""

# Baixando acidentes_por_uf_geral.csv
if not os.path.exists("acidentes_por_uf_geral.csv"):

  link = "https://drive.google.com/uc?export=view&id=1f8Tuk2eR87zWksiihxoKB_KX-Pcnue-C"
  wget.download(link, "acidentes_por_uf_geral.csv")

# Baixando acidentes_por_tipo_geral.csv
if not os.path.exists("acidentes_por_tipo_geral.csv"):

  link = "https://drive.google.com/uc?export=view&id=1_sfW7qdqH42ebHTD23Yd8uloCnWRjN8V"
  wget.download(link, "acidentes_por_tipo_geral.csv")

# Baixando acidentes_por_uf_geral.csv
if not os.path.exists("acidentes_por_br_geral.csv"):

  link = "https://drive.google.com/uc?export=view&id=1m65NQPBtlhhIXom1yZFDHzGCfJuYwgrZ"
  wget.download(link, "acidentes_por_br_geral.csv")

# Baixando acidentes_por_causa_geral.csv
if not os.path.exists("acidentes_por_causa_geral.csv"):

  link = "https://drive.google.com/uc?export=view&id=18Sp4oFMuRpAwYTu2NjK7nd6x7Y0aMmgG"
  wget.download(link, "acidentes_por_causa_geral.csv")
...
#!unzip "/content/drive/My Drive/datasets-bergson/PRF.zip" -d "dados"
...
def gera_grafico_por_tipo(ano, contagem_por_tipo_ano):
  ...
  chart = alt.Chart(contagem_por_tipo_ano).mark_bar().encode(
...
df_acidentes_causa_geral

df_filtrado = df_acidentes_causa_geral[(df_acidentes_causa_geral['ano'] == 2020)]
graf1 = gera_grafico_por_causa(2020, df_filtrado)
graf1
...
df_acidentes_br_geral

#df_acidentes_tipo_geral = pd.read_csv('acidentes_por_tipo_geral.csv', sep=',', encoding="ISO-8859-1")

df_filtrado_br = df_acidentes_br_geral[(df_acidentes_br_geral['ano'] == 2023)]
grafico_aba_03 = gera_grafico_por_br('2023', df_filtrado_br)
grafico_aba_03

# Commented out IPython magic to ensure Python compatibility.
# %%writefile acidentes-rodovias-brasil-streamlit.py
# import pandas as pd
# import numpy as np
# import streamlit as st
# import altair as alt
...
# import folium
# 
# # read a csv file from google drive export url
# #from google.colab import drive
# #drive.mount('/content/drive')
# 
# #!unzip "/content/drive/My Drive/datasets-bergson/PRF.zip" -d "dados"
...
!streamlit run acidentes-rodovias-brasil-streamlit.py & npx localtunnel --port 8501